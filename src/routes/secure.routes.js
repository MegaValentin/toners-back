...
import { adminFunction, employeeFunction, superAdminFunction } from "../controller/secure.controller.js";
const router = Router()

router.get('/admin', authRequired, verifyRole('admin'), adminFunction);
router.get('/superadmin', authRequired, verifyRole('superadmin'), superAdminFunction);
