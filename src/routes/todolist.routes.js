...
import { getTasks, getTask, addTask, assingTask, deleteTask } from "../controller/todolist.controller.js";
...
router.delete('/task/:id',authRequired, verifyRole(['superadmin']), assingTask)

router.put('/task/:id/assing',authRequired, verifyRole(['superadmin']), deleteTask)
