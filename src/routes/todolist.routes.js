...
import { getTasks, getTask, addTask, assignTask , deleteTask, completeTask, getMyTasks, revertTask, generateTasksReport} from "../controller/todolist.controller.js";
...
router.get("/tasks/report", authRequired, verifyRole(["admin", "superadmin"]), generateTasksReport);
